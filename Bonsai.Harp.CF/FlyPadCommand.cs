...
namespace Bonsai.Harp.CF
{
    ...
    public class FlyPadCommand : SelectBuilder, INamedElement
    {
        public FlyPadCommand()
        {
        ...
        {
            get { return typeof(FlyPadCommand).Name + "." + Type.ToString(); }
        }
        ...
        protected override Expression BuildSelector(Expression expression)
        {
            switch (Type)
            {
                ...
                case FlyPadCommandType.StartAcquisition:
                    return Expression.Call(typeof(FlyPadCommand), "ProcessStartAcquisition", new[] { expression.Type }, expression);
                case FlyPadCommandType.StopAcquisition:
                    return Expression.Call(typeof(FlyPadCommand), "ProcessStopAcquisition", new[] { expression.Type }, expression);
                ...
                case FlyPadCommandType.DigitalOut:
                    ...
                    return Expression.Call(typeof(FlyPadCommand), "ProcessDigitalOut", null, expression);

                /************************************************************************/
                /* Register: USE_AVERAGE                                                */
                /************************************************************************/
                case FlyPadCommandType.EnableAverage:
                    return Expression.Call(typeof(FlyPadCommand), "ProcessEnableAverage", new[] { expression.Type }, expression);
                case FlyPadCommandType.DisableAverage:
                    return Expression.Call(typeof(FlyPadCommand), "ProcessDisableAverage", new[] { expression.Type }, expression);
                ...
                case FlyPadCommandType.GainCh1:
                    ...
                    return Expression.Call(typeof(FlyPadCommand), "ProcessGainCh1", null, expression);
                case FlyPadCommandType.GainCh2:
                    if (expression.Type != typeof(bool)) { expression = Expression.Convert(expression, typeof(byte)); }
                    return Expression.Call(typeof(FlyPadCommand), "ProcessGainCh2", null, expression);
                ...
                case FlyPadCommandType.AverageTimeConstant:
                    if (expression.Type != typeof(bool)) { expression = Expression.Convert(expression, typeof(byte)); }
                    return Expression.Call(typeof(FlyPadCommand), "ProcessAverageTimeConstant", null, expression);
